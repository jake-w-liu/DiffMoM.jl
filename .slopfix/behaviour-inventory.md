...
| 2026-08-26 | INV-044, INV-048 | Required cross-platform test jobs have a 60-minute budget so the full bounds-checked Windows suite can finish before the quality gate. | The latest Windows job was cancelled at the configured 30-minute job timeout while Ubuntu, macOS, documentation, and both local thread-count suites passed. |
