...
```julia
build_nearfield_preconditioner(A::MatrixFreeEFIEOperator, cutoff; neighbor_search=:spatial, factorization=:lu, ilu_tau=1e-3, max_green_cache_bytes=268_435_456, max_green_cache_entries=250_000)
```
